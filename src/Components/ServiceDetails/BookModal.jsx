    ...
    <div
      ...
      <div className="w-[90%] lg:w-[50%] bg-[#ffffff] dark:bg-color-dark-lite rounded-lg p-4 max-h-[80vh] overflow-y-auto">
        <div className="w-full flex items-end justify-end">
          <RxCross1 className="p-2 text-[2.5rem] hover:bg-[#e7e7e7] dark:hover:bg-gray-600 rounded-full transition-all duration-300 cursor-pointer" onClick={() => setModalOpen(false)} />
        </div>
        ...
        <form onSubmit={handleSubmit(onSubmit)} className="space-y-3">
          ...
          <div>
            ...
            <input type="text" className="inputField cursor-not-allowed" value={_id} disabled />
          </div>
          ...
          <div>
            ...
            <input type="text" className="inputField cursor-not-allowed" value={serviceName} disabled />
          </div>
          ...
          <div>
            ...
            <input type="text" className="inputField cursor-not-allowed" value={serviceImage} disabled />
          </div>
          ...
          <div>
            ...
            <input type="text" className="inputField cursor-not-allowed" value={serviceProvider?.name} disabled />
          </div>
          ...
          <div>
            ...
            <input type="text" className="inputField cursor-not-allowed" value={serviceProvider?.email} disabled />
          </div>
          ...
          <div>
            ...
            <input type="text" className="inputField cursor-not-allowed" value={user?.displayName} disabled />
          </div>
          ...
          <div>
            ...
            <input type="text" className="inputField cursor-not-allowed" value={user?.email} disabled />
          </div>
          ...
          <div>
            ...
            <input type="number" className="inputField cursor-not-allowed" value={servicePrice} disabled />
          </div>
          ...
          <div>
            ...
            <input type="text" className="inputField cursor-not-allowed" value={serviceArea} disabled />
          </div>
          ...
          <div>
            ...
            <input type="date" defaultValue={new Date().toISOString().split('T')[0]} className="inputField" {...register('serviceTakingDate', { required: 'Talking Date is Required' })} />
            {errors.serviceTakingDate && (
              <p className="flex text-red-500 gap-1 items-center">
                <MdError /> {errors.serviceTakingDate.message}{' '}
              </p>
            )}
          </div>
          ...
          <div>
            ...
            {errors.specialInstruction && (
              <p className="flex text-red-500 gap-1 items-center">
                <MdError /> {errors.specialInstruction.message}{' '}
              </p>
            )}
          </div>
