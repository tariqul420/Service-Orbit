...
const Footer = () => {
  return (
    <div className="pt-4 w-full bg-gray-100 dark:bg-[#121b27]">
      <div className="w-11/12 mx-auto grid grid-cols-1 md:grid-cols-3 lg:grid-cols-5 gap-10 mb-8">
        <div className="space-y-4">
          <Link to="/">
            <div className="flex items-center gap-2">
              <img src="/service-logo.png" alt="Logo" className="w-8" />
              <h2 className="font-extrabold text-1xl">Service Orbit</h2>
            </div>
          </Link>
      ...
      <p className="dark:text-white/70 text-center py-4 border-t border-solid border-color-primary-d dark:border-white">
        &copy; Copyright <Link to="/">Service_Orbit</Link> {new Date().getFullYear()}. All Right Reserved
      </p>
    </div>
  );
};
