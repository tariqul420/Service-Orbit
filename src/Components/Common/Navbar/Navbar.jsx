...
const Navbar = () => {
    ...
    return (
        <nav
            className={`w-full py-6 sticky top-0 z-[1000] bg-white dark:bg-[#121b27] transition-transform duration-300 ${showNavbar ? "translate-y-0" : "-translate-y-full"}`}
        >
                            ...
                            {user && (
                                <li>
                                    ...
                                    >
                                        ...
                                        <IoIosArrowUp
                                            className={`${dashboardOpen ? "rotate-0" : "rotate-[180deg]"
