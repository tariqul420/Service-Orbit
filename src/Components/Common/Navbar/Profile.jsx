...
const Profile = () => {
    ...
    return (
        <div className="flex items-center gap-[10px] cursor-pointer relative"
            ...
            <div
                className={`${accountMenuOpen ? "translate-y-0 opacity-100 z-[1]" : "translate-y-[10px] opacity-0 z-[-1]"} bg-white w-max rounded-md boxShadow absolute top-[45px] right-0 p-[10px] flex flex-col transition-all duration-300 gap-[5px] dark:bg-gray-700 shadow-md`}>
                <p
