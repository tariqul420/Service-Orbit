...
const PaymentCard = ({ type, price }) => {
  return (
    <div data-aos="flip-left" className="group mt-8">
      <div className="p-8 bg-[#F4FAFF] dark:bg-color-dark-lite/50 rounded-t-3xl border-t border-x border-solid border-gray-300 group-hover:bg-[#052642] group-hover:text-white transition-all duration-300 ease-in-out">
        <button className="px-6 rounded-md py-0 bg-white text-xl text-[#7C33F5]">{type}</button>
      ...
      <div className="space-y-1 p-8 bg-[#FFFFFF] dark:bg-color-dark-lite/70 rounded-b-3xl border-b border-x border-solid border-gray-300 group-hover:bg-[#FDEEEE] dark:group-hover:bg-[#052c4e] transition-all duration-300 ease-in-out">
        <p className="flex gap-1 items-center">
          <IoCheckmarkCircleOutline /> Booking
        </p>
        <p className="flex gap-1 items-center">
          <IoCheckmarkCircleOutline /> Own Cover Image on Provider
        </p>
        <p className="flex gap-1 items-center">
          <IoCheckmarkCircleOutline /> 5 Project At least
        </p>
        <p className="flex gap-1 items-center">
          <IoCheckmarkCircleOutline /> More Locations (Branches)
        </p>
        <p className="flex gap-1 items-center">
          <IoCheckmarkCircleOutline /> Apply for Job
        </p>
        <p className="flex gap-1 items-center">
          <IoCheckmarkCircleOutline /> Contact Numbers
        </p>
        <p className="flex gap-1 items-center">
          <IoCheckmarkCircleOutline /> STAFF MEMBERS
        </p>
        <p className="flex gap-1 items-center">
          <IoCheckmarkCircleOutline /> 442 Free Templates
        </p>
        <p className="flex gap-1 items-center">
          <IoCheckmarkCircleOutline /> QR Code
        </p>
        <p className="flex gap-1 items-center">
          <IoCheckmarkCircleOutline /> Invoice
        </p>
      </div>
    </div>
  );
