    ...
    <section className="w-11/12 md:w-10/12 mx-auto h-auto flex flex-col-reverse lg:flex-row my-0 lg:my-12">
      ...
      <div className="shadow-md backdrop-blur-3xl rounded-lg sm:py-6 sm:px-8 p-4 flex flex-col gap-5 flex-1">
        <form onSubmit={handleSubmit(onSubmit)} className="w-full flex flex-col gap-5">
          <h3 className="text-[3rem] font-[700] text-center">Update Service</h3>
          ...
          {/* Service Name */}
          <div>
            <input type="text" placeholder="Service Name" className="inputField" defaultValue={serviceDetails?.serviceName} {...register('serviceName', { required: 'Services Name is required' })} />
            {errors.serviceName && (
              <p className="flex text-red-500 gap-1 items-center">
          ...
          {/* Service Area */}
          <div>
            <input type="text" placeholder="Service Area" className="inputField" defaultValue={serviceDetails?.serviceArea} {...register('serviceArea', { required: 'Services Area is required' })} />
            {errors.serviceArea && (
              <p className="flex text-red-500 gap-1 items-center">
