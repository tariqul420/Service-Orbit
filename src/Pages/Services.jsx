...
const Services = () => {
  ...
  useEffect(() => {
    axios.get(`${import.meta.env.VITE_API_URL}/all-services?search=${search}`).then((res) => {
  ...
  return (
    <>
      <section className="my-12">
        ...
        {services.length === 0 ? (
          <div className="boxShadow p-6 sm:px-20 sm:py-14 flex items-center justify-center flex-col gap-[4px] rounded-xl dark:bg-color-dark-lite bg-white shadow-md mt-12">
