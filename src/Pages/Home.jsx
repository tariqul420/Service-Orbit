...
const Home = () => {
  ...
  return (
    <section className="overflow-x-hidden">
      ...
      {/* Popular Services */}
      <div className="mb-28">
        <h2 data-aos="fade-up" className="text-5xl font-bold text-center max-sm:text-4xl">
          Popular Services
        </h2>
        {data?.popularServices.length === 0 ? (
          <div className="p-6 sm:px-20 sm:py-14 flex items-center justify-center flex-col gap-[4px] rounded-xl dark:bg-color-dark-lite bg-white shadow-md mt-12">
      ...
      <div className="mb-28">
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 lg:grid-cols-4 gap-2 mt-12">
          {data?.bestProvider.map((service, index) => (
            <BestProvider key={index} service={service} />
          ))}
        </div>
      </div>
      ...
      {/* Success */}
      <div data-aos="fade-up" className="bg-[url(https://i.ibb.co.com/59Yyn7H/background.png)] bg-cover bg-no-repeat rounded-3xl mb-28">
        <div className="grid lg:grid-cols-4 md:grid-cols-2 grid-cols-1 py-20 gap-20 lg:gap-0 px-8">
          <div data-aos="fade-right" className="flex items-center justify-center flex-col">
            <p className="lg:text-[8vw] md:text-[20vw] text-[40vw] leading-none font-bold text-border font-mono" style={{ color: 'transparent', WebkitTextStroke: '2px white' }}>
              <CountUp start={0} end={52} duration={2.5} />K
            </p>
            <p className="text-white font-bold text-5xl">Customers</p>
          </div>

          <div data-aos="flip-left" className="flex items-center justify-center flex-col">
            <p className="lg:text-[8vw] md:text-[20vw] text-[40vw] leading-none font-bold text-border font-mono" style={{ color: 'transparent', WebkitTextStroke: '2px white' }}>
              <CountUp start={0} end={42} duration={2.5} />K
            </p>
            <p className="text-white font-bold text-5xl">Reviews</p>
          </div>

          <div data-aos="flip-right" className="flex items-center justify-center flex-col">
            <p className="lg:text-[8vw] md:text-[20vw] text-[40vw] leading-none font-bold text-border font-mono" style={{ color: 'transparent', WebkitTextStroke: '2px white' }}>
              <CountUp start={0} end={2} duration={2.5} />M
            </p>
          ...
          <div data-aos="fade-left" className="flex items-center justify-center flex-col">
            <p className="lg:text-[8vw] md:text-[20vw] text-[40vw] leading-none font-bold text-border font-mono" style={{ color: 'transparent', WebkitTextStroke: '2px white' }}>
              <CountUp start={0} end={3} duration={2.5} />K
            </p>
      ...
      <div className="mb-28">
        <h2 data-aos="fade-up" className="text-5xl font-bold text-center max-sm:text-4xl">
          Our Stories As Told By <br className="max-sm:hidden" /> Customers
        </h2>

        <div className="mt-12 flex flex-col gap-8">
          <Slider {...settings}>
            {data?.toldCustomer.map((review, index) => (
              <ToldCustomers key={index} review={review} />
            ))}
          </Slider>
        </div>
      </div>
